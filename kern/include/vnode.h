...
#define MAX_FILENAME_LEN 60 // Mirrors sfs.h setting
#define BUF_SIZE 4096 // Not sure about this
...
struct vnode {
	...
	//added by rahmanmd
	struct lock *vn_dirlock;      /* Lock for operation on a directory */
...
// Added by tocurtis -- may need to move elsewhere
// Note that this structure described at jhshi.me
// Initialization code in vnode.c
...
// Added by tocurtis
// Code to initialize a file descriptor

int fdesc_init(struct fdesc *f_desc, struct vnode *vn);

//Added by rahmanmd
//A global filesystems lock
